using AcademiaLoja.Application.Commands.Orders;
...
using AcademiaLoja.Application.Queries.Orders;
...
namespace AcademiaLoja.Web.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        {
            // Verificar se o pedido pertence ao usuário atual (exceto para administradores)
